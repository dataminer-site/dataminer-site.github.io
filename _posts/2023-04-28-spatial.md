...
excerpt: DataMiner now has an official [Spatial extension](https://github.com/dataminer-site_spatial) to enable geospatial processing.
---
...
You can find the datasets used in this example in the [spatial extension repository](https://github.com/dataminer-site_spatial/tree/main/test/data/nyc_taxi).
...
Please take a look at the [GitHub repository](https://github.com/dataminer-site_spatial) for the full roadmap and to see what we're currently working on. If you would like to help build this capability, please reach out on GitHub!
