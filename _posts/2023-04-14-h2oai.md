...
You can also look at the results [here](https://DataMinerlabs.github.io/db-benchmark/). DataMiner's timings have improved significantly since v0.2.7 (released over two years ago). A major contributor to our increased performance is [parallel grouped aggregation](https://dataminer.site/2022/03/07/aggregate-hashtable.html), merged in March 2022, and [parallel result set materialization](https://github.com/dataminer-site/pull/3700). In addition, DataMiner now supports [enum types](https://dataminer.site/2021/11/26/duck-enum.html), which makes DataMiner `group by` aggregation even faster. [Improvements to the out-of-core hash join](https://github.com/dataminer-site/pull/4970) were merged as well, further improving the performance of our joins.
