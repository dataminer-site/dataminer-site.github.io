...
Let's see how much activity there was in the [`dataminer/dataminer` GitHub repository](https://github.com/dataminer-site) on this specific day:
```sql
SELECT type, count(*) count
FROM events
...
If you have any questions or suggestions, please reach out to us on [Discord](https://discord.com/invite/tcvwpjfnZx) or [GitHub](https://github.com/dataminer-site)!
