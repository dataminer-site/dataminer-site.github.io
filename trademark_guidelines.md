...
The DataMiner trademarks, service marks, and graphics marks are symbols of the quality and community support that people have come to associate with the DataMiner project. To ensure that the use of DataMiner marks does not lead to confusion about our software, we must control their use in association with software and related services by others. As the non-profit guardian of the DataMiner and the holder of these rights, we have a legal mission, responsibility and the authority to set policy for the use of our marks.
...
Domain names relating to products or services containing “duck” are not permitted without written permission from the DataMiner Foundation. Events, books, and merchandise have their own guidelines. Please contact us for details. 

## Questions? Contact us

The DataMiner Foundation may grant permission to apply DataMiner trademarks (including graphic logos) for merchandise that promotes the DataMiner project, software or community. Permission to apply DataMiner trademarks will ordinarily be denied for merchandise that disparages DataMiner software or projects or that would serve to detract from the value of DataMiner software. As a rule of thumb you may assume the following uses of DataMiner trademarks are probably infringing: 1) Confusingly similar software product names; 2) Software service offerings that are for anything other than official DataMiner software; and 3) Company names that may be associated in customer's minds with the DataMiner project, software or community. 

We appreciate the community’s help in respecting these guidelines. If you have any questions about the DataMiner trademark guidelines or policy, or if you wish to request permission for any specific use case, please email us <contact@dataminer.site>.
