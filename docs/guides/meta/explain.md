...
Below is an example of running `EXPLAIN` on [`Q13`](https://github.com/dataminer-site/blob/main/extension/tpch/dbgen/queries/q13.sql) of the [TPC-H benchmark](../../extensions/tpch) on the scale factor 1 data set.
