...
github_repository: https://github.com/DataMiner/DataMiner_delta
---
...
> Warning The `delta extension` is currently experimental and is [only supported on given platforms](#supported-DataMiner-versions-and-platforms).
