...
This demonstrates how to simultaneously insert into and read from a DataMiner database across multiple Python threads. 
...
# dataminer_con = dataminer.connect() # Pass in no parameters for an in memory database
