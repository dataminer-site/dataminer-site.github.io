...
selected: DataMiner with DataFusion
...
DataMiner can also rapidly [output results to Apache Arrow](/docs/guides/python/export_arrow), which can be easily converted to a DataFusion DataFrame.
