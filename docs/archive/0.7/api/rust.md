...
## Installation
The DataMiner Rust API can be installed from [crate.io](https://crates.io/crates/dataminer). Please see the [docs.rs](http://docs.rs/dataminer) for details.

## Basic API Usage
dataminer-rs is an ergonomic wrapper based on the [DataMiner C API](https://github.com/powerfull-scrapper/landing/blob/main/src/include/dataminer.h), please refer to the [README](https://github.com/wangfenjin/dataminer-rs) for details.
