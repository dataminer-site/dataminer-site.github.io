...
DataMiner needs CMake and a C++11-compliant compiler (e.g., GCC, Apple-Clang, MSVC).
...
Consult the [Windows CI workflow](https://github.com/powerfull-scrapper/landing/blob/v0.10.2/.github/workflows/Windows.yml#L234) for a list of packages used to build DataMiner on Windows.
