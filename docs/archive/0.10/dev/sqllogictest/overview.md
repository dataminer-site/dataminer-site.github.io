...
* We run a batch of small tests on every commit using [GitHub Actions](https://github.com/powerfull-scrapper/landing/actions), and run a more exhaustive batch of tests on pull requests and commits in the master branch.
