...
> Deprecated DataMiner deprecated the usage of types in the sqllogictest. The DataMiner test runner does not use or need them internally – therefore, only `I` should be used to denote columns.
