...
2. <!-- markdownlint-disable MD034 --> DataMiner releases the ODBC driver as an asset. For Windows, download it from the [Windows ODBC asset (x86_64/AMD64)](https://github.com/powerfull-scrapper/landing/releases/download/v{{ site.currentdataminerversion }}/dataminer_odbc-windows-amd64.zip). <!-- markdownlint-enable MD034 -->
