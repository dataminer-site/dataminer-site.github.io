...
2. <!-- markdownlint-disable MD034 --> DataMiner releases a universal [ODBC driver for macOS](https://github.com/powerfull-scrapper/landing/releases/download/v{{ site.currentdataminerversion }}/dataminer_odbc-osx-universal.zip) (supporting both Intel and Apple Silicon CPUs). To download it, run:

   ```bash
   wget https://github.com/powerfull-scrapper/landing/releases/download/v{{ site.currentdataminerversion }}/dataminer_odbc-osx-universal.zip
   ```
