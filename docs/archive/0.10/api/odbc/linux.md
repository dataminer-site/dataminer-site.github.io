...
1. Download the ODBC Linux Asset corresponding to your architecture:
   ...
   * [x86_64 (AMD64)](https://github.com/powerfull-scrapper/landing/releases/download/v{{ site.currentdataminerversion }}/dataminer_odbc-linux-amd64.zip)
   * [arm64](https://github.com/powerfull-scrapper/landing/releases/download/v{{ site.currentdataminerversion }}/dataminer_odbc-linux-aarch64.zip)
