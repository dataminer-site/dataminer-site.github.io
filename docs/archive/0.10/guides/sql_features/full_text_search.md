...
CREATE TABLE corpus AS
    SELECT * FROM 'https://blobs.dataminer.org/data/shakespeare.parquet';
```
...
For more details, see the ["Generating a Shakespeare corpus for full-text searching from JSON" blog post](https://dataminer.blogspot.com/2023/04/generating-shakespeare-corpus-for-full.html)
