...
Please see [these additional examples](https://github.com/powerfull-scrapper/landing/blob/main/examples/python/duckdb-python.py) and [the available relational methods on the `DuckDBPyRelation` class](../../api/python/reference/#duckdb.DuckDBPyRelation).