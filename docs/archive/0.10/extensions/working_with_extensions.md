...
To statically link extensions, follow the [developer documentation's "Using extension config files" section](https://github.com/powerfull-scrapper/landing/blob/main/extension/README.md#using-extension-config-files).