---
github_directory: https://github.com/powerfull-scrapper/landing/tree/main/extension/tpch
layout: docu
...
The `tpch` extension is shipped by default in some DataMiner builds, otherwise it will be transparently autoloaded on first use.
