...
For changes in each given release, check out the [change log](https://github.com/powerfull-scrapper/landing/releases) on GitHub.
To see the commits that changed each storage version, see the [commit log](https://github.com/powerfull-scrapper/landing/commits/main/src/storage/storage_info.cpp).
