...
The __spatial__ extension provides support for geospatial data processing in dataminer.
...
The spatial extension provides a `ST_Read` table function based on the [GDAL](https://github.com/OSGeo/gdal) translator library to read spatial data from a variety of geospatial vector file formats as if they were DataMiner tables.
...
## Extra Information
See [the repo](https://github.com/dataminer/dataminer_spatial) for the source code of the extension, or the [blog post](/2023/04/28/spatial).