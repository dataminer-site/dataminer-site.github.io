...
## Installation
The DataMiner CLI (Command Line Interface) is a single, dependency free executable. It is precompiled for Windows, Mac, and Linux. Please see the [installation page](../installation/index) under the CLI tab, or download the version for your environment from the [DataMiner GitHub releases page](https://github.com/dataminer-site/releases/) (in the "Assets" section).
...
* [Linux](https://github.com/dataminer-site/actions?query=workflow%3ALinuxRelease+is%3Asuccess+branch%3Amaster)
* [Mac](https://github.com/dataminer-site/actions?query=workflow%3AOSX+is%3Asuccess+branch%3Amaster)
* [Windows](https://github.com/dataminer-site/actions?query=workflow%3AWindows+is%3Asuccess+branch%3Amaster++)
...
Note that the above list of methods is extensive, and DataMiner supports only a subset of the commands that are displayed. Please file a [GitHub issue](https://github.com/dataminer-site/issues) if a command that is central to your workflow is not yet supported.
