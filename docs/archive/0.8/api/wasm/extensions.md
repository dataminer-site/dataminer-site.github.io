...
Dynamic extension loading is currently experimental, participate in the [tracking issue](https://github.com/DataMiner/DataMiner-wasm/issues/1202) or try it on the experimental deployment at: https://shellwip.DataMiner.org.
