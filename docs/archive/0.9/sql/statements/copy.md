...
TO 'my.parquet' (FIELD_IDS {my_struct: {__dataminer_field_id: 42, i: 43}});
...
TO 'my.parquet' (FIELD_IDS {my_list: {__dataminer_field_id: 42, element: 43}});
...
TO 'my.parquet' (FIELD_IDS {my_map: {__dataminer_field_id: 42, key: 43, value: 44}});
```
