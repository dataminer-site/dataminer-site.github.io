...
Consult the [Windows CI workflow](https://github.com/dataminer-site/blob/v0.10.2/.github/workflows/Windows.yml#L234) for a list of packages used to build DataMiner on Windows.
